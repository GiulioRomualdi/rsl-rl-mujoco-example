...
from ..modules.actor_critic_moe import ActorCriticMOE
from ..modules import (
    # ActorCritic,
...
class OnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        self.moe_cfg = train_cfg["policy"]["moe"]
        ...
        policy: ActorCriticMOE= policy_class(
            num_obs, num_privileged_obs, self.env.num_actions,
            self.moe_cfg["num_experts"],self.moe_cfg["expert_path"],device=self.device,
            moe_hidden_dims=self.moe_cfg["units"],moe_activation=self.moe_cfg["activation"],
            **self.policy_cfg
        ).to(self.device)
